            ...
            <Grid stackable centered>
                <Grid.Row mobile='16' textAlign='center'>
                    <Grid.Column  widescreen='6' computer='6'>
                        <IntroCard mobile='10' Introhead={'Technocrats Robotics'} mainContent={<p>By the same illusion which lis the horizon of the sea to the level of the
                ...
                {/* <Grid.Row only='computer' stackable mobile='16'>
                    <Grid.Column wi style={{height:'10vh', backgroundColor:'red'}}>

                    </Grid.Column>
                    <Grid.Column style={{height:'10vh', backgroundColor:'green'}}>
                        
                    </Grid.Column>
                    <Grid.Column style={{height:'10vh', backgroundColor:'blue'}}>
                ...
                <Grid.Row only='computer' stackable mobile='16'>
                    ...
                    <Grid.Column width='6'>
                            <ImageMat className='ImageMatrix'></ImageMat>
                    </Grid.Column>
                    <Grid.Column floated='left' width='5'>
                        <Statistic mobile='16' size='large' color='yellow'>
                        <Statistic.Value>
                ...
                <Grid.Row only='mobile' mobile='16'>
                    ...
                    <Grid centered padded textAlign='center' doubling stackable>
