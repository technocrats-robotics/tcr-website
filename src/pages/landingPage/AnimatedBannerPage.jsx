...
export default class AnimatedBannerPage extends PureComponent {
  ...
  closePopup = () => {
    document.getElementsByClassName("recruitmentRibbon")[0].style.display =
      "none";
  };
  render() {
    return (
