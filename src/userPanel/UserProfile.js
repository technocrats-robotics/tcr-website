...
function addCardListenter() {
  ...
  document
    .getElementsByClassName("aboutuscard")[0]
    .addEventListener("click", (e) => {
      if (
        document.getElementsByClassName("aboutuscard")[0].style
          .webkitTransform === "rotateY(0.5turn)"
      ) {
        document.getElementsByClassName("aboutuscard")[0].style.cssText =
  ...
  const roles = (yearly_roles) => {
    ...
    return (
      <p
        ...
        style={{ margin: "3px", width: "100px", textAlign: "center" }}
      >
        {currentRole[0]}
        <br></br>
        {currentRole[1]}
      ...
      {userDetails && userDetails.isActive ? (
        <div className="ui grid userProfile__display">
          <div className="sixteen wide mobile sixteen wide tablet sixteen wide computer column">
            ...
            <div className="display__roles">{roles(userDetails.roles)}</div>
          </div>
            ...
            <div className="ui grid">
              <div className="sixteen wide column">
                <div className="ui stackable two column grid">
                  <div className="column">
                    <div className="userProfile__fields">
                      ...
                      <div className="userProfile__ans">
                        {userDetails.registeredEmail}
                      </div>
                    </div>
                  </div>
                  <div className="column">
                ...
                <div className="ui stackable two column grid">
                  <div className="column">
                    <div className="userProfile__fields">
                      <div className="userProfile__label">
                        Year Of Joining :{" "}
                      </div>
                      <div className="userProfile__ans">
                        {userDetails.yearOfJoining}
                      </div>
                    </div>
                  </div>
                  <div className="column">
                ...
                <div className="inputBox">
                  <div className="ui fluid labeled input">
                    ...
                    <input
                      type="url"
                      defaultValue={userDetails.dpLink}
                      placeholder="Provide a valid link for your DP."
                    ...
                    <div className="column">
                      <div className="inputBox2">
                        <div className="ui fluid labeled input">
                          ...
                          <input
                            type="text"
                            defaultValue={userDetails.social_media.github}
                    ...
                    <div className="column">
                      <div className="inputBox2">
                        <div className="ui fluid labeled input">
                          ...
                          <input
                            type="text"
                            defaultValue={userDetails.social_media.instagram}
                    ...
                    <div className="column">
                      <div className="inputBox2">
                        <div className="ui fluid labeled input">
                          ...
                          <input
                            type="text"
                            defaultValue={userDetails.social_media.linkedIn}
                ...
                <div className="inputBox">
                  <div className="ui fluid labeled input">
                    <div className="ui label userSocial">Tagline</div>
                    <input
                      defaultValue={userDetails.about.misc}
                      placeholder="Personal Tagline (under 50 characters)"
                ...
                <div className="inputBox">
                  <div className="ui fluid labeled input">
                    ...
                    <input
                      defaultValue={userDetails.about.experience}
                      placeholder="Experience with the Team (under 50 characters; don't fill unless an Alumnus/Alumna)"
                ...
                <div className="userProfile__message">
                  {success}
                  {warning}
                </div>
              </div>
        ...
        <div className="userProfile__blockMessage">
          ...
          <h4>
            Or feel free to write us at: <u>technocratsroboticsvit@gmail.com</u>
          </h4>
        </div>
      )}
    </div>
