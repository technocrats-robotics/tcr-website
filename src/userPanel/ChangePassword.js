...
function ModalExampleBasic() {
  ...
  function validatePassword() {
    ...
    if (regex.test(newPassword)) {
      if (newPassword !== confirmPassword) return 404;
      return true;
    } else return false;
  }
        ...
        <form onSubmit={handleSubmit}>
          <div className="inputBox">
            <div
              ...
              data-tooltip="Must contain atleast 8 characters including one UPPERCASE,lowercase,numeric and a special character."
          ...
          <div className="inputBox">
            <div className="changePassword__error">
              ...
              confirmPassword !== null
                ? "Must contain atleast 8 characters including one UPPERCASE,lowercase,numeric and a special character."
                : null}
            </div>
            <div className="changePassword__warning">
              {validatePassword() === 404 && confirmPassword !== null
                ? "New Password and Confirmation password do not match."
                : null}
            </div>
            <div className="changePassword__success">
              {validatePassword() === true
                ? "Verified!! Click on Submit button to change your Password"
                : null}
            </div>
          </div>
