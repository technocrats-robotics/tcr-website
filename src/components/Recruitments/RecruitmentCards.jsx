...
export default class Recruitments extends Component {
  ...
  expandInfo = (e) => {
    ...
    let recruitText = e.target.parentElement.parentElement.parentElement.children[1];
    recruitText.style.display=recruitText.style.display==="block"?"none":"block";
  ...
  render() {
    return(
      <Grid centered columns={10}>
        ...
        <Icon onClick={this.expandInfo} color="yellow" size="mini" name='angle down' />
