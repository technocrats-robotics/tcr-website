              ...
              <div className="screen">
                ...
                <div className="screen-body">
                  <div className="screen-body-item left">
                    ...
                    <div className="app-contact">CONTACT INFO : technocratsroboticsvit@gmail.com</div>
                  </div>
                  <form onSubmit={handleSubmit}>
                    <div className="screen-body-item">
                      <div className="app-form">
                        ...
                        <div className="contactForm__warningMessage">
                          {warning}
                        </div>
                        <div className="app-form-group">
                          <input className="app-form-control" placeholder="NAME" onChange={(event)=>setName(event.target.value)} required/>
                        </div>
                        <div className="app-form-group">
                          <input className="app-form-control" placeholder="EMAIL" onChange={(event)=>setEmail(event.target.value)} required/>
                        </div>
                        <div className="app-form-group">
                          <input className="app-form-control" placeholder="CONTACT NO" onChange={(event)=>setContact(event.target.value)} required/>
                        </div>
                        <div className="app-form-group message">
                          <input className="app-form-control" placeholder="MESSAGE" onChange={(event)=>setMessage(event.target.value)} required/>
                        </div>
